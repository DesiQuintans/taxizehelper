...
- Desi Quintans [@eco_desi](https://twitter.com/eco_desi)
...
Below is the first few rows of `search_gnr()`'s output. The ICN ranks are ordered so that you can access them with `kingdom:genus`. I intentionally kept an old name in the case of _Hadrocolletes fulvus_, and `taxize` retrieved the current genus _Leioproctus_.
